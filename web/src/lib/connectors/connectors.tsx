...
> = {
  ...
  bamboohr: {
    ...
    values: [
        ...
        tabs: [
          ...
          },
          {
            ...
            fields: [
              ...
              {
                type: "list",
                query: "Enter time-off types to include:",
                label: "Time-Off Types",
                name: "time_off_types",
                description: "Include only time-off records of specific types (e.g., 'Vacation', 'Sick')",
                optional: true,
              },
            ],
          },
      ...
      {
        type: "checkbox",
        query: "Include time-off records?",
        label: "Include Time-Off",
        name: "include_time_off",
        description: "Whether to index time-off records from BambooHR",
        optional: true,
        default: true,
      },
      {
